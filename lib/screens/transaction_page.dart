...
class TransactionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Expense Tracker - Transactions'),
        ),
        body: Padding(
...
class TotalExpenseWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final totalExpense =
        Provider.of<ExpenseProvider>(context).totalExpense;
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              // For transaction page, you might not need a delete button.
              // If you want to keep it, you can uncomment the following lines.
              // trailing: IconButton(
